...
/// transfers and receipt information. The `IReceiptV3` MUST call the relevant
...
/// token interface. The combination of `IReceiptV3` and `IReceiptManagerV*`
...
interface IReceiptV3 is IERC1155 {
    ...
    /// @param sender The sender to operate the transfer.
